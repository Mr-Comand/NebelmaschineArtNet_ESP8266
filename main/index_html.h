        ...
        <div class=\"config\">\n\
            ...
            <div class=\"wlan\" id=\"Wlan1\">\n\
                ...
                <form id=\"wlanForm1\">\n\
                    ...
                    <input class=\"button save\" type=\"button\" value=\"Save\" onclick=\"saveConfig('wlanForm1', '/wlan1')\">\n\
                </form>\n\
            </div>\n\
            <div class=\"wlan\" id=\"Wlan2\">\n\
                ...
                <form id=\"wlanForm2\">\n\
                    <input type=\"text\" class=\"input\" name=\"ssid\" maxlength=\"32\" placeholder=\"Wlan SSID\">\n\
                    <input type=\"password\" class=\"input\" name=\"pwd\" maxlength=\"63\" placeholder=\"Password\">\n\
                    <input class=\"button save\" type=\"button\" value=\"Save\" onclick=\"saveConfig('wlanForm2', '/wlan2')\">\n\
                </form>\n\
            </div>\n\
            <div class=\"wlan\" id=\"Wlan3\">\n\
                ...
                <form id=\"wlanForm3\">\n\
                    <input type=\"text\" class=\"input\" name=\"ssid\" maxlength=\"32\" placeholder=\"Wlan SSID\">\n\
                    <input type=\"password\" class=\"input\" name=\"pwd\" maxlength=\"63\" placeholder=\"Password\">\n\
                    <input class=\"button save\" type=\"button\" value=\"Save\" onclick=\"saveConfig('wlanForm3', '/wlan3')\">\n\
                </form>\n\
            </div>\n\
